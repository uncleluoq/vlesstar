...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/uncleluoq/vlesstar.git)
...
|**端口**|443|
|**用户ID**|447f6cbc-ca14-11ec-9d64-0242ac120002<br>**注意：务必使用自己创建的UUID。不要使用本项目中示范的UUID！**|
